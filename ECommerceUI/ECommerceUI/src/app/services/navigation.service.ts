...
export class NavigationService {
  baseUrl = 'https://localhost:7054/api/Shopping/';
  ...
  getProduct(id: number){
    let url = this.baseUrl + "GetProduct/" +id.toString();
  ...
  getAllPerviousCarts(userid: number){
  ...
  insertPayment(payment: Payment){
    return this.http.post(this.baseUrl + 'InsertPayment', 
    payment,{responseType:'text'});
  }
